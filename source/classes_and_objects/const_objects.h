...
General Notes:
        ...
        The correct implementation is Test Case 5
...
void test2()
{
    ...
    Notes:  #define Test2
            ...
            Test Case : Const objects - Direct access
...
void test4()
{
    ...
    Notes:  #define Test4
            ...
            Test Case : Const Objects as function arguments
    */
        cout << "--------------------------------------------------------------------------------" << endl;
...
void test5()
{
    ...
    Notes:  #define Test5
            ...
            Test Case : Const Member functions
    */
        cout << "--------------------------------------------------------------------------------" << endl;
