...
int main(){
    ...
    // Notes: constinit keyword introduced in C++20 
    // to initialized a variable at compile time
    // to avoid problems with the order of initialization of global variables outside of the main function
