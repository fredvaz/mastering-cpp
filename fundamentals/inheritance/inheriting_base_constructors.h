...
void test2()
{
    ...
    Notes:  #define Test2
            ...
            EXAMPLE : Inheriting Custom Person Base Constructor
    */
    ...
    // Another EXAMPLE: Compiler Error this Constructor is not declared in Person neither in Engineer Class
...
void test3()
{
    ...
    Notes: #define Test3
           ...
           EXAMPLE : Uses the Custom Engineer Constructor 
    */
