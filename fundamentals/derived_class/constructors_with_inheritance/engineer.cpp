...
#if defined(Test2)
// EXAMPLE : whitout initialize the Person object class in the Constructor
...
// EXAMPLE : Set up our own Copy Constructor with Inheritance from Person class : Person(source)
