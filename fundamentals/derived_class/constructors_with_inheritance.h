...
void test2()
{
    ...
    Notes:  #define Test2
            ...
            EXAMPLE_: the Person object class is initialized with the Copy Custom constructor
            supose for EXAMPLE_ for some memory dynamic memory allocation
...
void test3()
{
    ...
    */
    ...
    // EXAMPLE_: Copy Custom constructor Person object class
...
void test4()
{
    ...
    Notes: #define Test4
           ...
           EXAMPLE_: now CivilEngineer Constructor has to initialize with the Engineeer Constructor
