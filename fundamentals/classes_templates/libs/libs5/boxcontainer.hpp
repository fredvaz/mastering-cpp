...
//* Specializing get_max() method
template <> inline //! inline to compiler the definition here in the header file
...
//* Specializing get_max() method - Just declaration Definition in cpp file
// template <>
// const char *BoxContainer<const char *>::get_max() const;
